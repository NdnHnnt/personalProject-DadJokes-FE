    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="text-base font-semibold leading-7 text-indigo-600">Ceriakan harimu!</h2>
          <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
            DadJokes hadir untuk menemani harimu
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-600">
            DadJokes menyediakan platform bagi segala umur untuk menghibur publik melalui jokes bapak-bapak :D
          </p>
        </div>
